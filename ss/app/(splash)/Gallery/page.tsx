...
export default function Gallery() {
    return (
        <motion.section id="gallery" className="text-center leading-8 mb-20"
        initial={{opacity:0, y:100}}
        animate={{opacity:1, y:0}}
        transition={{delay:0.175}}>
          <h1 className="text-left ml-8 text-6xl">Gallery</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0.5">
          <div className="relative w-80 h-40 ml-8 mt-10">
