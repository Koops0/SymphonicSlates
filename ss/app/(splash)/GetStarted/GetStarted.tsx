  ...
  return (
    <div className="flex grow flex-col">
      <div className="flex flex-col justify-center items-center h-full mt-32">
        ...
        <h1 className="mb-8 -mt-8 flex flex-col items-center gap-8 text-center text-4xl font-extrabold leading-none tracking-tight">
          See Sounds. Hear Colours.
        </h1>
        <div className="flex justify-center items-center h-full">
          <div className="relative flex items-center ml-64 -mt-10 ">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
